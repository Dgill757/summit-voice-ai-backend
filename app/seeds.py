...
AGENT_SEED_DATA: list[dict[str, Any]] = [
    ...
    {"agent_id": 8, "agent_name": "Meeting Scheduler", "tier": "Revenue", "schedule_cron": "0 */2 9-17 * * 1-5", "description": "Books discovery calls and confirms meetings"},
    ...
    {"agent_id": 13, "agent_name": "Engagement Monitor", "tier": "Content", "schedule_cron": "*/30 8-18 * * 1-5", "description": "Tracks comments and engagement signals"},
    {"agent_id": 14, "agent_name": "Trend Analyzer", "tier": "Content", "schedule_cron": "0 7 * * 1,4", "description": "Discovers trending content opportunities"},
    {"agent_id": 15, "agent_name": "Client Onboarder", "tier": "ClientSuccess", "schedule_cron": None, "description": "Automates onboarding workflows"},
    ...
    {"agent_id": 18, "agent_name": "Churn Predictor", "tier": "ClientSuccess", "schedule_cron": "0 8 * * 1,4", "description": "Flags accounts with churn risk"},
...
def seed_agents(db: Session) -> int:
    ...
    for item in AGENT_SEED_DATA:
        ...
        if row is None:
            ...
            row.tier = item["tier"]
            row.schedule_cron = item["schedule_cron"]
